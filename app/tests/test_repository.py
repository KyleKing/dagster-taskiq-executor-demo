...
class TestRepositoryDefinitions:
    ...
    def test_schedule_job_references_exist(self):
        ...
        for schedule in schedules:
            ...
            assert schedule_job_name in job_names, (
                f"Schedule {schedule.name} references non-existent job {schedule_job_name}"
            )
    ...
    def test_repository_completeness(self):
        ...
        assert defs.sensors is None or len(defs.sensors) == 0
