...
1. Port executor scaffolding into `dagster_taskiq` and consolidate shared utilities from the demo (`taskiq_executor/__init__.py`).
1. Begin M2 implementation tasks per Stage 01-02 plan, coordinating updates to `.ai/plans` for standalone packaging milestones.
