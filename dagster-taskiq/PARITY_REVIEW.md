...
1. ✅ Priority handling fixed - `_priority_to_delay_seconds()` correctly maps higher priority to lower delay
1. Implement queue selection parity: honour run/step tags when building SQS queue names and ensure executors/launchers submit to user-selected queues. (See `../TODO.md`)
